...
exports.makeAddPlayerToGame = exports.makeHokm = exports.makePlayCard = exports.makeFindGame = exports.makeListOfGames = exports.makeAddGame = void 0;
const game_1 = require("../domain/game/game");
...
function makeAddPlayerToGame(gameDb) {
    return async function (gameName, socket_id, name) {
        ...
        const game = new game_1.Gamebuilder(game_data.nameOfGame)
            .reBuild(game_data)
            .build();
